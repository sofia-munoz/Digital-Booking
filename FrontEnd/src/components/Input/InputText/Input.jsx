...
export default function Input ({label, handleValue, valueContent, placeHolderContent, obligatory }) {
  return (
    <div className={styles.input_container}>
        <label htmlFor=''>{label}</label>
        <input type="text" onChange={(e) =>{handleValue(e.target.value)}} value={valueContent} placeholder={placeHolderContent}/>
