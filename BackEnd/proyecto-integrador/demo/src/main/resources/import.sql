...
insert into caracteristicas (caracteristica)values('Televisor');
insert into caracteristicas (caracteristica)values('Aire Acondicionado');
insert into caracteristicas (caracteristica)values('Apto mascotas');
insert into caracteristicas (caracteristica)values('Estacionamiento gratuito');
insert into caracteristicas (caracteristica)values('Pileta');
insert into caracteristicas (caracteristica)values('Wifi');
...
insert into ciudades (ciudad)values('Cerrillos');
insert into ciudades (ciudad)values('Cordoba');
insert into ciudades (ciudad)values('Villa Carlos Paz');
insert into ciudades (ciudad)values('Santa María');
insert into ciudades (ciudad)values('Los Altos');
...
---productos---
insert into productos (descripcion, disponibilidad, imagen_principalurl,titulo,titulo_descripcion,ubicacion,id_categoria,id_ciudad,id_politica,id_provincia)values('Una vez en el alojamiento, hay jardín, estacionamiento privado y terraza. También cuenta con cocina compartida, room service y wifi gratis en todas las instalaciones. El hotel dispone de habitaciones familiares. El Palacio Barolo se encuentra a 3,7 km del hotel, mientras que el teatro Colón está a 3,8 km. El aeropuerto más cercano es el aeropuerto Jorge Newbery Airfield, situado a 6 km del Hotel Provincial del Once.',null,'https://0521ptc6n2db-grupo5-imagenes.s3.us-east-2.amazonaws.com/imagenes-frontend/producto1/prod1-1.jpg','Hotel Provincial del Once','El Hotel Provincial del se encuentra en Buenos Aires, a 3,6 km del Obelisco de Buenos Aires.','24 de Noviembre 191',2,1,1,1);
insert into productos (descripcion, disponibilidad, imagen_principalurl,titulo,titulo_descripcion,ubicacion,id_categoria,id_ciudad,id_politica,id_provincia)values('Este hotel de 3 estrellas ofrece actividades para niños, salón compartido y wifi gratis. Hay recepción 24 horas, room service y cambio de divisa. Las habitaciones disponen de aire acondicionado, escritorio, caja fuerte, TV de pantalla plana y baño privado con bidet. Todas las habitaciones del Hotel Traful están equipadas con ropa de cama y toallas. El alojamiento sirve un desayuno buffet. El Hotel Traful ofrece alojamiento de 3 estrellas con pileta cubierta y parque infantil.',null,'https://0521ptc6n2db-grupo5-imagenes.s3.us-east-2.amazonaws.com/imagenes-frontend/producto2/prod2-1.jpg','Hotel Traful','El Hotel Traful se encuentra en Mar del Plata, a 200 metros de la playa de La Perla, y ofrece alojamiento con terraza y estacionamiento privado.',' Hipólito Yrigoyen 1190, La Perla',1,1,1,1);
insert into productos (descripcion, disponibilidad, imagen_principalurl,titulo,titulo_descripcion,ubicacion,id_categoria,id_ciudad,id_politica,id_provincia)values('El lodge ofrece patio, vistas a la pileta, zona de estar, TV de pantalla plana vía satélite, zona de cocina totalmente equipada con microondas y heladera y baño privado con bidet y secador de pelo. El Complejo Turístico Chachingo cuenta con parrilla. Se proporciona servicio de alquiler de autos.',null,'https://0521ptc6n2db-grupo5-imagenes.s3.us-east-2.amazonaws.com/imagenes-frontend/producto3/prod3-1.jpg','Complejo Turístico Chachingo','El Complejo Turístico Chachingo se encuentra en Maipú, a 8 km de la bodega La Rural y de la bodega Trapiche, y ofrece alojamiento con wifi gratis, aire acondicionado y acceso a un jardín con pileta al aire libre.','Unión Vecinal 5507',2,4,1,2);
insert into productos (descripcion, disponibilidad, imagen_principalurl,titulo,titulo_descripcion,ubicacion,id_categoria,id_ciudad,id_politica,id_provincia)values('Los alojamientos están equipados con TV de pantalla plana con canales vía satélite, zona de cocina con heladera, microondas, fogones y hervidor de agua, y baño privado con bañera o ducha, bidet, artículos de aseo gratuitos y secador de pelo. Algunos incluyen zona de comedor y/o patio. Se proporciona la ropa de cama.',null,'https://0521ptc6n2db-grupo5-imagenes.s3.us-east-2.amazonaws.com/imagenes-frontend/producto4/prod4-1.jpg','Finca Fisterra','La Finca Fisterra ofrece alojamiento con aire acondicionado en Maipú, a 8 km de la bodega La Rural. Además, se halla a 9 km de la bodega Trapiche y proporciona conexión WiFi gratuita.','Videla Aranda 7685',1,4,1,2);
insert into productos (descripcion, disponibilidad, imagen_principalurl,titulo,titulo_descripcion,ubicacion,id_categoria,id_ciudad,id_politica,id_provincia)values('Las habitaciones del Hostal Rustyk tienen baño privado o compartido. Las habitaciones superiores gozan de vistas al jardín. El Hostal Rustyk dispone de zona de parrilla, jardín y mostrador de información turística. El Hostal Rustyk se encuentra a 186 km del aeropuerto internacional Martín Miguel de Güemes.',null,'https://0521ptc6n2db-grupo5-imagenes.s3.us-east-2.amazonaws.com/imagenes-frontend/producto5/prod5-1.jpg','Hostal Rustyk','El Hostal Rustyk está situado a 200 metros del centro de Cafayate y a 5 km de las cataratas del río Colorado. Ofrece desayunos continentales, conexión de wifi gratis y cocina común completamente equipada.','Rivadavia 281',2,5,1,3);
insert into productos (descripcion, disponibilidad, imagen_principalurl,titulo,titulo_descripcion,ubicacion,id_categoria,id_ciudad,id_politica,id_provincia)values('Se encuentra a 500 metros de la Bodega Nanni y ofrece jardín y estacionamiento privado gratuito. Esta casa cuenta con aire acondicionado, 1 dormitorio, TV de pantalla plana, zona de comedor y cocina con heladera y horno. Se proporcionan toallas y ropa de cama. Los viñedos de San Carlos se encuentran a 13 km de la casa.',null,'https://0521ptc6n2db-grupo5-imagenes.s3.us-east-2.amazonaws.com/imagenes-frontend/producto6/prod6-1.jpg','Lo de Vichenzo','Lo de Vicente ofrece vistas al jardín y alojamiento con patio y hervidor de agua a 1,9 km de Bodega el Esteco.','Barrio el Tránsito 4427',1,5,1,3);
insert into productos (descripcion, disponibilidad, imagen_principalurl,titulo,titulo_descripcion,ubicacion,id_categoria,id_ciudad,id_politica,id_provincia)values('This apartment is 5.2 km from Cordoba Shopping Mall and 8.9 km from Mario Alberto Kempes Football Stadium. This air-conditioned apartment features 1 bedroom, a flat-screen TV, and a kitchen. Cordobas Civic Centre is 2.7 km from the apartment, while España Square is 3.7 km from the property.',null,'https://0521ptc6n2db-grupo5-imagenes.s3.us-east-2.amazonaws.com/imagenes-frontend/producto7/prod7-1.jpg','La Cañada','Situated 1.7 km from Patio Olmos Shopping Mall, 1.5 km from Catedral de Cordoba and 1.6 km from Jesuit Square, La Cañada features accommodation set in Cordoba.','468 Avenida Figueroa Alcorta 6 G',3,7,1,4);
insert into productos (descripcion, disponibilidad, imagen_principalurl,titulo,titulo_descripcion,ubicacion,id_categoria,id_ciudad,id_politica,id_provincia)values('Los alojamientos disponen de cocina totalmente equipada, TV de pantalla plana y aire acondicionado. El AT Suites alberga una terraza. También ofrece consigna de equipaje y servicio de camarera de pisos diario. Se proporciona ropa de cama. Este alojamiento se encuentra a 12,8 km del aeropuerto internacional Ingeniero Ambrosio Taravella. Nuestros clientes dicen que esta parte de Córdoba es su favorita, según los comentarios independientes.',null,'https://0521ptc6n2db-grupo5-imagenes.s3.us-east-2.amazonaws.com/imagenes-frontend/producto8/prod8-1.jpg','AT Suites','¡Podés conseguir un descuento Genius en AT Suites!','Boulevard Iliia 50, Nueva Córdoba',4,7,1,4);
insert into productos (descripcion, disponibilidad, imagen_principalurl,titulo,titulo_descripcion,ubicacion,id_categoria,id_ciudad,id_politica,id_provincia)values('El Departamento Chacabuco 2 ofrece alojamiento con wifi gratis en San Fernando del Valle de Catamarca, a 2,1 km de la plaza del Aborigen, a 1,8 km de la Plazoleta Los Primeros Vecinos y a 3,1 km de la Plazoleta de la Ermita de Nuestra Señora del Valle. Este departamento se encuentra a 3,4 km de la plaza y a 3,6 km de Popular Norte.',null,'https://0521ptc6n2db-grupo5-imagenes.s3.us-east-2.amazonaws.com/imagenes-frontend/producto9/prod9-1.jpg','Departamento Chacabuco','Departamento con aire acondicionado, 1 dormitorio, TV de pantalla plana y cocina.','145 Avenida Los Olivos',3,10,1,5);
insert into productos (descripcion, disponibilidad, imagen_principalurl,titulo,titulo_descripcion,ubicacion,id_categoria,id_ciudad,id_politica,id_provincia)values('Todos los alojamientos disponen de aire acondicionado, baño privado, TV de pantalla plana y cocina totalmente equipada. La Quebrada se encuentra a 3 km del departamento, mientras que San Isidro está a 8 km. El aeropuerto más cercano es el aeropuerto internacional Coronel Felipe Varela, ubicado a 15 km del Lyfrago.',null,'https://0521ptc6n2db-grupo5-imagenes.s3.us-east-2.amazonaws.com/imagenes-frontend/producto10/prod10-1.jpg','Lyfrago','El Lyfrago se encuentra en San Fernando del Valle de Catamarca, en la provincia de Catamarca, y ofrece alojamiento con estacionamiento privado gratuito.','Doctor Tadeo Acuña 4700',4,10,1,5);
